...
<?php require_once ("../Layout/Menu.php");?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <a href="themsanpham.php" type="button" class="btn btn-default btn-sm" style="background-color: #ff551b; font-size: 14px;">
                ...
                <div class="col-md-20">
                    <div class="box">
                        <div class="box-header with-border">
                            <form method="post" class="sidebar-form" style="width: 40%;border: 0px">
                                <div class="input-group" style="border-radius:3px; border:1px solid black ">
                                    <input type="text" name="tim" class="form-control" placeholder="Search..." required>
                                    <span class="input-group-btn">
                                    <button type="submit" name="btntim" id="search-btn" class="btn btn-flat">
